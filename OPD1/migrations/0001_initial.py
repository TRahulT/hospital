# Generated by Django 4.1.9 on 2023-08-08 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opd_slip_number', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Patient_doc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OPD1.opd_table')),
            ],
        ),
        migrations.CreateModel(
            name='OperatorReport',
            fields=[
                ...
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('Patient_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OPD1.opd_table')),
            ],
        ),
        migrations.AddField(
            model_name='opd_table',
            name='User_UID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OPD1.patients'),
        ),
        migrations.AddField(
            model_name='opd_table',
            name='doctor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OPD1.doctor'),
        ),
        migrations.AddField(
            model_name='opd_table',
            name='modifiedBy',
